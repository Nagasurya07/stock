...
export default function Header({ onNewChat, onHome }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      {/* Profile Card Modal */}
      <Modal
        visible={profileCardOpen}
        transparent
        animationType="fade"
        onRequestClose={() => setProfileCardOpen(false)}
      >
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.drawer}>
            ...
            <View style={styles.menuContainer}>
              ...
              >
                <MaterialIcons name="article" size={24} color="#ff6b6b" />
                <Text style={styles.menuItemText}>News & Community</Text>
              </TouchableOpacity>
